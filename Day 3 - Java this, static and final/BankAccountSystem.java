...
class BankAccount{
	...
	static String bankName = "Bank Of Geeks";
	...
	public static void displayBankDetails(){
		System.out.println();
		System.out.print("\nDisplaying bank details below : \n");
		System.out.print("\nBank Name : " + bankName);
		System.out.print("\nTotal Number of accounts : " + getTotalAccounts());
	}
}
...
public class BankAccountSystem{
	public static void main(String[] args){
		...
		bankAccount1.bankHandler();
		
		BankAccount bankAccount2 = new BankAccount("Rohit", 101010, 2000);
		BankAccount.displayBankDetails();
		
		boolean result = bankAccount1 instanceof BankAccount;
